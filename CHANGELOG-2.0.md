...
- [#3019](https://github.com/hyperf/hyperf/pull/3019) Added config `service_governance.publish.enable` which is used to control whether to publish to service register.
