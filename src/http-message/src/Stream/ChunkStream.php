...
{
    /**
     * @var \Hyperf\HttpMessage\Stream\SwooleStream[]
     */
    protected $streams = [];

    protected $currentStream = 0;
    ...
    {
        throw new \RuntimeException('Cannot determine the position of a ChunkStream');
    }
    ...
    {
        throw new \RuntimeException('Cannot write to a chunkStream');
    }
    ...
    /**
     * @return array|\Hyperf\HttpMessage\Stream\SwooleStream[]
     */
