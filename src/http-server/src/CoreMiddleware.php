...
class CoreMiddleware implements MiddlewareInterface
{
    ...
    /**
     * @param MethodDefinitionCollectorInterface $methodDefinitionCollector
     */
    public function setMethodDefinitionCollector(MethodDefinitionCollectorInterface $methodDefinitionCollector): void
    {
        $this->methodDefinitionCollector = $methodDefinitionCollector;
    }
