...
class DatabaseMigratorIntegrationTest extends TestCase
{
    ...
    public function testCommentforMigration()
    {
        $schema = new Schema();
        ...
        $this->assertStringContainsString("ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Users Table'", $sql);
