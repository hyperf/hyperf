...
class DatabaseEloquentModelTest extends TestCase
{
    ...
    public function testModelObserversCanBeAttachedToModels()
    {
        ...
        $events->shouldReceive('listen')->once()->with('eloquent.creating: \HyperfTest\Database\EloquentModelStub', EloquentTestObserverStub::class.'@creating');
        $events->shouldReceive('listen')->once()->with('eloquent.saved: \HyperfTest\Database\EloquentModelStub', EloquentTestObserverStub::class.'@saved');
    ...
    public function testModelObserversCanBeAttachedToModelsThroughCallingObserveMethodOnlyOnce()
    {
        ...
        $events->shouldReceive('listen')->once()->with('eloquent.creating: \HyperfTest\Database\EloquentModelStub', EloquentTestAnotherObserverStub::class.'@creating');
        $events->shouldReceive('listen')->once()->with('eloquent.saved: \HyperfTest\Database\EloquentModelStub', EloquentTestAnotherObserverStub::class.'@saved');
     ...
     * @expectedExceptionMessage \HyperfTest\Database\EloquentModelStub::incorrectRelationStub must return a relationship instance.
     */
