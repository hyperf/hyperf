...
class ModelCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $option->setPool($pool)
            ...
            ->setNoFillable($this->getOption('no-fillable', 'commands.db:model.no_fillable', $pool, false));
    ...
    protected function configure()
    {
        ...
        $this->addOption('no-fillable', null, InputOption::VALUE_NONE, 'Whether generate fillable argement for model.');
    }
    ...
    protected function getOption(string $name, string $key, string $pool = 'default', $default = null)
    {
        ...
        $nonInput = in_array($name, ['force-casts', 'no-fillable']) ? false : null;
        if ($result === $nonInput) {
