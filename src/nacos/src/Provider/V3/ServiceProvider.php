...
namespace Hyperf\Nacos\Provider\v3;
...
class ServiceProvider extends AbstractProvider
{
    public function create(
        ...
        return $this->request('POST', 'nacos/v3/admin/ns/service', [
    ...
    {
        return $this->request('DELETE', 'nacos/v3/admin/ns/service', [
    ...
    public function update(
        ...
        return $this->request('PUT', 'nacos/v3/admin/ns/service', [
            RequestOptions::QUERY => $this->filter(array_merge($optional, [
                'serviceName' => $serviceName,
            ])),
        ]);
    ...
    {
        return $this->request('GET', 'nacos/v3/admin/ns/service', [
            RequestOptions::QUERY => $this->filter([
                'serviceName' => $serviceName,
                'groupName' => $groupName,
                'namespaceId' => $namespaceId,
    ...
    {
        return $this->request('GET', 'nacos/v3/admin/ns/service/list', [
            RequestOptions::QUERY => $this->filter([
                'pageNo' => $pageNo,
                'pageSize' => $pageSize,
                'groupName' => $groupName,
