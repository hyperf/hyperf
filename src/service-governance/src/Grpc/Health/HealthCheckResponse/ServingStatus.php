...
namespace Hyperf\ServiceGovernance\Grpc\Health\HealthCheckResponse;
...
class_alias(ServingStatus::class, \Hyperf\ServiceGovernance\Grpc\Health\HealthCheckResponse_ServingStatus::class);
