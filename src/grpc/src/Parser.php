...
class Parser
{
     ...
     * @return array{0:null|Message,1:stdClass{code:int,details:string,metadata:array,rawResponse:null|Http2Response},2:null|Http2Response}
     */
