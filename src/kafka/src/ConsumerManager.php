...
use Hyperf\Kafka\Exception\FailToConsumeException;
            ...
            public function handle(): void
            {
                    ...
                    function (ConsumeMessage $message) use ($consumer, $consumerConfig) {
                        ...
                        wait(function () use ($consumer, $consumerConfig, $message) {
                            ...
                            try {
                                ...
                                throw new FailToConsumeException($message, previous: $exception);
                            }
                ...
                while (true) {
                    try {
                        ...
                        $this->dispatcher?->dispatch(new FailToConsume($consumer, [], $exception));
                    }
