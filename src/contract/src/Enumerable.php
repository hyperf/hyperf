...
use Hyperf\Utils\Exception\ItemNotFoundException;
use Hyperf\Utils\Exception\MultipleItemsFoundException;
...
interface Enumerable extends Arrayable, Countable, IteratorAggregate, Jsonable, JsonSerializable
{
     ...
     *
     * @param array<array-key, TKey>|\Illuminate\Support\Enumerable<array-key, TKey>|string $keys
     * @return static
     */
