...
- [#6897](https://github.com/hyperf/hyperf/pull/6897) [#6898](https://github.com/hyperf/hyperf/pull/6898) Added event `BeforeLongLangConsumerCreated` and `AfterConsumerConfigCreated` into `Hyperf\Kafka\ConsumerManager`.
