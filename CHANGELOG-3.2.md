...
- [#7653](https://github.com/hyperf/hyperf/pull/7653) Improved `Parser::parseResponse` return value format by replacing `Grpc\StringifyAble` with `stdClass` for better standardization and code readability.
