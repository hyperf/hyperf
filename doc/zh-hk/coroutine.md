...
> 注意 `MySQL` 等異步模塊已在[4.3.0](https://wiki.swoole.com/wiki/page/p-4.3.0.html)中移除，並轉移到了[swoole_async](https://github.com/swoole/ext-async)。
...
> Concurrent 僅可在 1.0.16 版本或更高版本使用
...
> Override 方法僅可在 1.0.12 版本或更高版本使用
