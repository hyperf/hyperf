...
- [#3209](https://github.com/hyperf/hyperf/pull/3209) [#3212](https://github.com/hyperf/hyperf/pull/3212) Fixed bug that connection was not be released to pool when the amqp consumer broken in coroutine style server.
