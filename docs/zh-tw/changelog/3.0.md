...
- [#6209](https://github.com/hyperf/hyperf/pull/6209) 為 `Redis` [哨兵模式](https://github.com/phpredis/phpredis/blob/develop/sentinel.md#examples-for-version-60-or-later) 增加 `ext-redis:^6.0` 的支援。
