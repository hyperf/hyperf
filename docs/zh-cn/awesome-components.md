...
- [xdebug](https://xdebug.org/docs/install) 如果 Swoole 的版本是 >=v5.0.1 , 直接用 xdebug 调试
- [swoole/yasd](https://github.com/swoole/yasd) Swoole 调试器，类似 `Xdebug`，完美支持协程，支持断点调试、单步追踪、`watch` 变量 (swoole
- >= v5.0.1 请用 xdebug)
