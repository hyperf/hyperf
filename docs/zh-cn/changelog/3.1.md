...
- [#6774](https://github.com/hyperf/hyperf/pull/6774) 为 `Hyperf\Database\Query\Builder` 增加 `Lateral Join`。 
- [#6781](https://github.com/hyperf/hyperf/pull/6781) 为 `Hyperf\Collection\Arr` 增加一些新的方法。
- [#6782](https://github.com/hyperf/hyperf/pull/6782) 为 `Hyperf\Database\Query\Builder` 新增 `whereJsonOverlaps`,`orWhereJsonOverlaps` 和 `whereJsonDoesntOverlap`。
- [#6783](https://github.com/hyperf/hyperf/pull/6783) 为 `Hyperf\Database\Query\Builder` 增加 `insertOrIgnoreUsing`。
- [#6784](https://github.com/hyperf/hyperf/pull/6784) 为 `Hyperf\Collection\Collection` 增加 `getOrPut` 和 `getOrSet`。

## 优化

- [#6777](https://github.com/hyperf/hyperf/pull/6777) 为 `StdoutLogger` 优化自定义参数的展示。
