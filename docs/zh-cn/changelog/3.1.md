...
- [#6509](https://github.com/hyperf/hyperf/pull/6509) 修复 `Crontab` 组件的 `Schedule::call()` 方法不支持 `array` 参数。

## 优化

- [#6511](https://github.com/hyperf/hyperf/pull/6511) 优化异步队列消息体结构 `Hyperf\AsyncQueue\JobMessage`。
- [#6513](https://github.com/hyperf/hyperf/pull/6513) 使用 `tracer` 组件时，使用 `Hyperf\Coroutine\Coroutine` 代替 `Hyperf\Engine\Coroutine`。
