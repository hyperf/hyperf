...
With `hyperf/dag`, a `DAG` can be constructed and executed as follows.
...
```php
// The second parameter of Vertex::make is an optional parameter, which is the key of vertex, which is the key value of the result array.
