...
class ErrorCode
{
    ...
    public static $messages = [
        ...
        self::PARAMS_INVALID => 'parameter illegal'
    ];
}
...
// Below version 1.2 The following methods can be used, but will be removed in version 1.2
$message = ErrorCode::getMessage(ErrorCode::PARAMS_INVALID, 'user_id');
```
...
For related configuration, see [Internationalization](zh-cn/translation.md)
