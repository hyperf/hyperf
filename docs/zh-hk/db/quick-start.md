...
可以在 PhpStorm 中安裝 [Hyperf Query](https://plugins.jetbrains.com/plugin/33333-hyperf-query) 插件，為 Hyperf 查詢構造器提供數據庫集成支持。它配合 DataGrip 為數據庫 schema、數據表、視圖和列提供自動完成，主要功能如下：

- 查詢構造器和 Schema 構造器方法中 schema、數據表、視圖、列的自動完成
- 遷移文件（migration）中的自動完成
