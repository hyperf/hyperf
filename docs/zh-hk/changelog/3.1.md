...
- [#6509](https://github.com/hyperf/hyperf/pull/6509) 修復 `Crontab` 組件的 `Schedule::call()` 方法不支持 `array` 參數。

## 優化

- [#6511](https://github.com/hyperf/hyperf/pull/6511) 優化異步隊列消息體結構 `Hyperf\AsyncQueue\JobMessage`。
- [#6513](https://github.com/hyperf/hyperf/pull/6513) 使用 `tracer` 組件時，使用 `Hyperf\Coroutine\Coroutine` 代替 `Hyperf\Engine\Coroutine`。
