...
[Nginx](http://nginx.org/) é um servidor `HTTP` e de proxy reverso de alta performance, com o código implementado completamente em `C`. Com base em sua alta performance e diversas vantagens, podemos configurá-lo como o servidor front-end do `hyperf`, implementando load balancing (balanceamento de carga) ou servidor front-end HTTPS, entre outros.

## Configurando o proxy HTTP
...
## Configurando o proxy Websocket
